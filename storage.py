...
ACCOUNT_DEFAULTS: dict[str, Any] = {
    ...
    "mining_enabled": True,
    "mining_time": "01:00",         # якорь (МСК) ТОЛЬКО для ежедневной награды — сбор майнинга теперь
                                     # на своём отдельном интервале, см. mining_check_interval_minutes
    "mining_check_interval_minutes": 240,  # раз во сколько минут проверять/собирать майнинг (задаёт
                                            # пользователь в боте; было жёстко 4 часа = 240 мин)
    ...
    "repair_external_workshop_name": "",        # название/владелец конкретной чужой мастерской (подстрока
                                                 # для поиска в списке); пусто = любая первая свободная
